...
const NOTE = {
  ...
  '@samugen/cli':
    'Copyright (c) SamuGen. Licensed under the MIT License.\nhttps://www.npmjs.com/package/@samugen/cli',
}
...
function bareName(spec) {
  ...
  if (BUILTIN.has(name) || name.startsWith('@samugen/')) return null
...
let out = `SamuGen — Third-Party Software Notices
