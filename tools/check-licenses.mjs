/**
 * Dependency license gate: every production npm dependency must carry a license from the permissive
 * allowlist, so a copyleft dependency cannot slip into a release.
 */
