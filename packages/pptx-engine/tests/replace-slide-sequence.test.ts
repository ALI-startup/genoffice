/**
 * Verifies the core replace_at sequence (redo one slide in place): mergeSlideFromPptx (new slide
 * appended at the end) → moveSlide (into position) → deleteSlide (remove old slide).
 */
