...
/**
 * A fast-xml-parser element node: attributes are '@_'-prefixed, text is '#text', child elements are
 * nested nodes (a single child collapses to an object instead of an array).
 */
