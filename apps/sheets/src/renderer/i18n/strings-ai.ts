...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiLoginSamuGen: '登录 SamuGen',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
    aiTimeoutError: 'AI 请求超时：网络长时间无响应，已停止。请检查网络后重试',
    aiCreditsExhausted: 'AI 服务商报告额度已用完，请在服务商处充值后重试',
  ...
  en: {
    ...
    aiLoginSamuGen: 'Sign in to SamuGen',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
    ...
    aiCreditsExhausted:
      'Your AI provider reports no credit left. Top up with the provider, then try again',
  ...
  ja: {
    ...
    aiCreditsExhausted:
      'AI プロバイダーが残高不足を報告しました。プロバイダー側でチャージしてから再試行してください',
  ...
  ko: {
    ...
    aiCreditsExhausted:
      'AI 공급자에 남은 크레딧이 없습니다. 공급자에서 충전한 후 다시 시도해 주세요',
  ...
  fr: {
    ...
    aiLoginSamuGen: 'Se connecter à SamuGen',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
    ...
    aiCreditsExhausted:
      "Votre fournisseur d'IA signale un crédit épuisé. Rechargez chez le fournisseur, puis réessayez",
  ...
  de: {
    ...
    aiLoginSamuGen: 'Bei SamuGen anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
    ...
    aiCreditsExhausted:
      'Dein KI-Anbieter meldet kein Guthaben mehr. Lade beim Anbieter auf und versuche es erneut',
  ...
  es: {
    ...
    aiLoginSamuGen: 'Iniciar sesión en SamuGen',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
    ...
    aiCreditsExhausted:
      'Tu proveedor de IA informa que no queda crédito. Recarga con el proveedor e inténtalo de nuevo',
  ...
  th: {
    ...
    aiLoginSamuGen: 'ลงชื่อเข้าใช้ SamuGen',
    aiModel: 'โมเดล',
    aiCancel: 'ยกเลิก',
    aiSave: 'บันทึก',
    ...
    aiCreditsExhausted:
      'ผู้ให้บริการ AI แจ้งว่าเครดิตหมดแล้ว โปรดเติมเครดิตกับผู้ให้บริการ แล้วลองใหม่',
  ...
  id: {
    ...
    aiLoginSamuGen: 'Masuk ke SamuGen',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Penyedia AI Anda melaporkan kredit habis. Isi ulang di penyedia lalu coba lagi',
  ...
  ru: {
    ...
    aiLoginSamuGen: 'Войти в SamuGen',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
    ...
    aiCreditsExhausted:
      'Поставщик ИИ сообщает, что кредиты исчерпаны. Пополните баланс у поставщика и повторите попытку',
  ...
  ar: {
    ...
    aiLoginSamuGen: 'تسجيل الدخول إلى SamuGen',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
    ...
    aiCreditsExhausted:
      'أبلغ مزوّد الذكاء الاصطناعي بنفاد الرصيد. يرجى إعادة الشحن عند المزوّد ثم المحاولة مجددًا',
  ...
  pt: {
    ...
    aiLoginSamuGen: 'Entrar no SamuGen',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
    ...
    aiCreditsExhausted:
      'Seu provedor de IA informa que não há mais crédito. Recarregue com o provedor e tente novamente',
  ...
  it: {
    ...
    aiLoginSamuGen: 'Accedi a SamuGen',
    aiModel: 'Modello',
    aiCancel: 'Annulla',
    aiSave: 'Salva',
    ...
    aiCreditsExhausted:
      'Il tuo provider di IA segnala credito esaurito. Ricarica presso il provider e riprova',
  ...
  pl: {
    ...
    aiLoginSamuGen: 'Zaloguj się do SamuGen',
    aiModel: 'Model',
    aiCancel: 'Anuluj',
    aiSave: 'Zapisz',
    ...
    aiCreditsExhausted:
      'Dostawca AI zgłasza brak środków. Doładuj konto u dostawcy i spróbuj ponownie',
  ...
  nl: {
    ...
    aiLoginSamuGen: 'Aanmelden bij SamuGen',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
    ...
    aiCreditsExhausted:
      'Je AI-provider meldt dat het krediet op is. Waardeer op bij de provider en probeer het opnieuw',
  ...
  ms: {
    ...
    aiLoginSamuGen: 'Log masuk ke SamuGen',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Penyedia AI anda melaporkan kredit telah habis. Tambah nilai dengan penyedia dan cuba lagi',
  ...
  hi: {
    ...
    aiLoginSamuGen: 'SamuGen में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
    ...
    aiCreditsExhausted:
      'आपका AI प्रदाता बताता है कि क्रेडिट समाप्त हो गया है। प्रदाता के पास रिचार्ज करें और फिर से प्रयास करें',
  ...
  'zh-TW': {
    ...
    aiLoginSamuGen: '登入 SamuGen',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
    aiTimeoutError: 'AI 請求逾時：網路長時間無回應，已停止。請檢查網路後重試',
    aiCreditsExhausted: 'AI 服務商回報額度已用完，請在服務商處儲值後重試',
