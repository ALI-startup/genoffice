/**
 * Type shim for @genoffice/file-parse's browser entry point, for the same reason as
 * file-parse.d.ts beside it: the package ships TS source, and its dependency
 * @genoffice/docx-engine does not compile under sheets' stricter options
 ...
 *
 * Reached only indirectly — @genoffice/platform-web's default attachment extractor imports
