...
const baseStrings = {
  zh: {
    ...
    onbNote3: 'AI 功能使用你自己的模型密钥或本地模型运行。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    onbBody2:
      'SamuGen is still in alpha and fully open source — read the code, report what breaks, and help decide where it goes next.',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features run on your own provider key or a local model.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    onbNote3: 'AI 機能はご自身のプロバイダーキー、またはローカルモデルで動作します。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    onbNote3: 'AI 기능은 직접 등록한 제공업체 키 또는 로컬 모델로 실행됩니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans SamuGen',
    ...
    onbBody2:
      'SamuGen est encore en alpha et entièrement open source : lisez le code, signalez ce qui ne marche pas et aidez à décider de la suite.',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA utilisent votre propre clé de fournisseur ou un modèle local.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    // First-run onboarding
    onbTitle1: 'Willkommen bei SamuGen',
    ...
    onbBody2:
      'SamuGen ist noch in der Alpha-Phase und vollständig Open Source: Lesen Sie den Code, melden Sie Fehler und entscheiden Sie mit, wie es weitergeht.',
    ...
    onbNote3:
      'KI-Funktionen laufen mit Ihrem eigenen Anbieter-Schlüssel oder einem lokalen Modell.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a SamuGen',
    ...
    onbBody2:
      'SamuGen aún está en alfa y es totalmente de código abierto: lee el código, informa de lo que falle y ayuda a decidir qué viene después.',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA usan tu propia clave de proveedor o un modelo local.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ SamuGen',
    ...
    onbBody2:
      'SamuGen ยังอยู่ในช่วงอัลฟ่าและเป็นโอเพนซอร์สทั้งหมด อ่านซอร์สโค้ด แจ้งปัญหาที่พบ และร่วมกำหนดทิศทางต่อไป',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI ทำงานด้วยคีย์ผู้ให้บริการของคุณเองหรือโมเดลในเครื่อง',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    // First-run onboarding
    onbTitle1: 'Selamat datang di SamuGen',
    ...
    onbBody2:
      'SamuGen masih dalam tahap alpha dan sepenuhnya open source: baca kodenya, laporkan yang rusak, dan bantu menentukan arah berikutnya.',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI berjalan dengan kunci penyedia Anda sendiri atau model lokal.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в SamuGen',
    ...
    onbBody2:
      'SamuGen пока в альфа-версии и полностью открыт: читайте код, сообщайте об ошибках и помогайте решать, каким он станет дальше.',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ работают с вашим собственным ключом провайдера или локальной моделью.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في SamuGen',
    ...
    onbBody2:
      'لا يزال SamuGen في مرحلة ألفا وهو مفتوح المصدر بالكامل: اقرأ الكود، وأبلغ عن الأخطاء، وشارك في تحديد ما سيأتي بعد ذلك.',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'تعمل ميزات الذكاء الاصطناعي بمفتاح المزود الخاص بك أو بنموذج محلي.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao SamuGen',
    ...
    onbBody2:
      'O SamuGen ainda está em alfa e é totalmente open source: leia o código, relate o que falhar e ajude a decidir o que vem a seguir.',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA funcionam com a sua própria chave de provedor ou um modelo local.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    // First-run onboarding
    onbTitle1: 'Benvenuto in SamuGen',
    ...
    onbBody2:
      'SamuGen è ancora in alpha e completamente open source: leggi il codice, segnala cosa non funziona e contribuisci a decidere il prossimo passo.',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA funzionano con la tua chiave del provider o con un modello locale.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    onbBody2:
      'SamuGen jest wciąż w fazie alfa i w pełni otwarty: czytaj kod, zgłaszaj błędy i współdecyduj o tym, co dalej.',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI działają z Twoim własnym kluczem dostawcy lub modelem lokalnym.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    onbBody2:
      'SamuGen is nog in alfa en volledig open source: lees de code, meld wat er stukgaat en bepaal mee wat er hierna komt.',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies werken met je eigen providersleutel of een lokaal model.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    // First-run onboarding
    onbTitle1: 'Selamat datang ke SamuGen',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'SamuGen masih dalam peringkat alfa dan sumber terbuka sepenuhnya: baca kodnya, laporkan masalah, dan bantu tentukan hala tuju seterusnya.',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI berjalan dengan kunci penyedia anda sendiri atau model tempatan.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-SamuGen',
    ...
    onbBody2:
      'SamuGen עדיין בגרסת אלפא והוא קוד פתוח לחלוטין: קראו את הקוד, דווחו על תקלות, ועזרו להחליט מה יהיה הצעד הבא.',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות ה-AI פועלות עם מפתח הספק שלכם או עם מודל מקומי.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    // First-run onboarding
    onbTitle1: 'SamuGen में आपका स्वागत है',
    ...
    onbBody2:
      'SamuGen अभी अल्फ़ा चरण में है और पूरी तरह ओपन सोर्स है: कोड पढ़ें, खराबी की जानकारी दें, और आगे की दिशा तय करने में मदद करें।',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ आपकी अपनी प्रोवाइडर की या किसी लोकल मॉडल से चलती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    onbNote3: 'AI 功能會使用你自己的模型金鑰或本機模型執行。',
    onbBack: '上一步',
  },
} as const
