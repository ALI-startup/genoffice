...
/** office/pdf formats extract text via @samugen/file-parse; images skip text extraction and go multimodal (slides:files-read-image) */
...
/** Extract attachment text via @samugen/file-parse (docx/pdf/pptx/xlsx/plain text) */
