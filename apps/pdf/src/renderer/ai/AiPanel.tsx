...
import { AgentLoop } from '@samugen/agent-core'
...
/** SamuGen brand mark (rounded-square sparkle badge), inline so it renders
 * crisply at device resolution instead of going through <img> rasterization */
export function SamuGenMark({ size = 18 }: { size?: number }): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        // The document mark reduced for a 18–26px icon slot: the pencil does not
        // survive that size, so the silhouette keeps the folded page, both sparkles
        // and the three lines, knocked out of one filled path.
        d="M22 6h58l28 28v90a6 6 0 0 1-6 6H22a6 6 0 0 1-6-6V12a6 6 0 0 1 6-6Z M80 6v28h28L80 6Z M46 21Q49.2 43.68 66 48Q49.2 52.32 46 75Q42.8 52.32 26 48Q42.8 43.68 46 21Z M86 55Q87.76 67.6 97 70Q87.76 72.4 86 85Q84.24 72.4 75 70Q84.24 67.6 86 55Z M32.0 92h66a4.0 4.0 0 0 1 0 8h-66a4.0 4.0 0 0 1 0 -8Z M32.0 105h66a4.0 4.0 0 0 1 0 8h-66a4.0 4.0 0 0 1 0 -8Z M32.0 118h36a4.0 4.0 0 0 1 0 8h-36a4.0 4.0 0 0 1 0 -8Z"
        fillRule="evenodd"
        fill="#3b82c4"
      />
    </svg>
